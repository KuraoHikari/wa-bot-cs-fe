...
const StatisticPage = () => {
  ...
  const editContactLimitDialog = (
    e: React.MouseEvent<HTMLButtonElement | HTMLDivElement>,
    contact: EditContact
  ) => {
    e.preventDefault();
    setEditContact(contact);
    setShowEditContactLimitDialog(true);
  };
          ...
          <TabsContent value="messages">
            <Card x-chunk="dashboard-05-chunk-3">
              <CardHeader className="px-7">
                ...
                <CardDescription>
                  Recent message from your wa-bot.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Separator />
          ...
          <TabsContent value="contacts">
            <Card x-chunk="dashboard-05-chunk-3">
              <CardHeader className="px-7">
                ...
                <CardDescription>
                  Recent contact from your wa-bot.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Separator />
                          ...
                          <TableCell className="table-cell">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent>
                                ...
                                <DropdownMenuItem
                                  onClick={(e) => {
                                    editContactLimitDialog(e, contact);
                                  }}
                                >
                                  <span className="flex items-center gap-3">
                            ...
                            <EditContactLimitDialog
                              ...
                              onClose={() =>
                                setShowEditContactLimitDialog(false)
                              }
                            />
                            {/* <DeletePostDialog
               post={post}
